...
namespace Nmtp.Native
{
    ...
    internal partial class LibMtp
    {
        ...
        private static extern int LIBMTP_Send_File_From_File(IntPtr device, [MarshalAs(UnmanagedType.LPUTF8Str)] string path,
            ref File filedata, ProgressFunction? callback, IntPtr data);

        public static int SendFile(IntPtr device, string path, ref File fileData, ProgressFunction? callback,
            IntPtr data)
        {
