...
namespace Nmtp.Native
{
    ...
    public partial class LibMtp
    {
        ...
        private static extern Error LIBMTP_Detect_Raw_Devices(ref IntPtr listOfDevices, ref int numberOfDevices);

        public static Error DetectRawDevices(ref IntPtr listOfDevices, ref int numberOfDevices)
        {
